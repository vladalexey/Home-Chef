...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget buildGradientTopCarousel() {
    return Padding(
      padding: EdgeInsets.only(left: 2.0, right: 20.0, top: 25.0, bottom: 10.0),
      child: Column(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          color: suggestionListColors[
                              randomInt.nextInt(suggestionListColors.length)],
